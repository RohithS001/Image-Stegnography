...
def driver():
        ...
        encrypt_data = int( "".join([str(ord(i)) for i in data]) )
        print(encrypt_data)
        encrypted_data = encryption(encrypt_data)
        print("Encrypted data : ",encrypted_data)
        decrypted_data = str(decryption(encrypted_data))
        

        n = 2
        chunks = [chr(int(decrypted_data[i:i+n])) for i in range(0, len(decrypted_data), n)]
        print("Decrypted data : ","".join(chunks)) 
